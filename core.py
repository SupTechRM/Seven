...
class Initialisation:
    ...
    def db_save(self, name, weather_api_key, compute_engine_api_key):
        ...
        jsonData = {"name": name, "dateCreated": dateCreated,
                    "wolframalpha_api": compute_engine_api_key}
    ...
    def startDocumentation(self, inputtext):
        try:
            ...
            self.speakData(
                "Installing Desktop App Packages. Executing Data. Predicting Output. Loading files... ")
            self.speakData(
                "This will take some time depending on your internet connection. Please wait. ")
            ...
            self.speakData(
                "Sorry. I have encountered an issue. Please try again later. For now you can manually try installing packages. Follow these instructions. ")
    ...
    def welcomeUser(self):
        ...
        # Introduce Seven
        response = random.choice(["A new user I see. Welcome. Welcome to Seven. Allow me to introduce myself. I am Seven, made by Rishabh Mishra, Sarthak Rawool, and Shubham Mishra. And about me well, I'm a damn brilliant guy! Here let me get you through setup",
    ...
    def yourName(self):
        ...
        self.apprun = input(
            "Do you want to run the app locally too (Y/N) [NPM is required]: ")
        self.weather_input = input(
            "Please enter your weather api key (If you do not have one, Please make one at https://openweathermap.org/api): ")
        self.compute_engine_input = input(
            "Please enter your WolframAlpha API key (If you do not have one, Please make one at https://products.wolframalpha.com/api/): ")
        self.db_save(self.your_name, self.weather_input,
                     self.compute_engine_input)
        if self.apprun != "N":
