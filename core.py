...
#     # Play File
#     SpeechSynthesizer(
#         "A new user I see. Welcome. Welcome to Seven. Let me introduce myself. I'm Seven. I'm a damn brilliant guy. That's all. Here let me get you through setup. Just one second.", path="main/data/speech/empyrean-app-332014-6fdfdc87b1df.json")
#
#     while True:
#
...
#
#             time.sleep(2)
#             SpeechSynthesizer("Just spell your name for me.", path="main/data/speech/empyrean-app-332014-6fdfdc87b1df.json")
